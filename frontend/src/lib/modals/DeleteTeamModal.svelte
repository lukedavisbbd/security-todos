<script>
    ...
    const performDeleteTeam = async () => {
        ...
        if (confirmationText.trim() !== team.team_name.trim()) {
        ...
        if ('ok' in result) {
            ...
            deleteError = result.err.message || 'Failed to delete team.';
        }
    };
        ...
        {:else}
            ...
            <article>
                <div class="consequences">
                    ...
                    <ul>
                        <li><strong>All {taskCount} task{taskCount !== 1 ? 's' : ''}</strong> in this team</li>
                        <li><strong>All task history</strong> and progress tracking</li>
                        <li><strong>All {memberCount} team membership{memberCount !== 1 ? 's' : ''}</strong></li>
                        <li><strong>The team itself</strong> and all associated data</li>
                    </ul>
                </div>

                <div class="confirmation-section">
                    <label class="confirmation-label" for="confirmation">
                        To confirm deletion, type the team name: <span class="team-name-highlight">{team.team_name}</span>
                    </label>
                    <input
                        id="confirmation"
                        type="text"
            ...
            <footer>
                <button 
                    ...
                    disabled={confirmationText.trim() !== team.team_name.trim()}
